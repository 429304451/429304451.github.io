...
var WenyuSp = cc.Sprite.extend({
    ctor: function (filename = res.wen1, fsh = res.wen2, vsh = res.wen3) {
...
var WenyuLayer = cc.Layer.extend({
    ...
    onEnter: function () {
        this._super();
        // 背景
        this.bag = new cc.Sprite(res.wen4).to(this).pp();
        // 滑块
        this.loadDisplay();
    ...
    loadDisplay: function () {
        for (var i = 0; i < 10; i++) {
            var item = new WenyuSp().to(this, 2).pp();
